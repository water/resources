...
För att behålla dataintegriteten i databasen behöver data valideras innan det sparas, denna validering kan ske antingen i \emhp{databas-} eller \emph{modell-lagret}.
