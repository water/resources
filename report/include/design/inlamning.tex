...
När en LabHasGroup skapas sätts objetet i tillståndet initialized. I detta tillstånd finns inga Submissions kopplade till entiteten och inlämning kan skapas fram tills dess att deadline har passerat.
