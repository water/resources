...
\begin{abstract}
    ...
    Projektets omfattning visade sig vara för stort för tidsrymden av ett kandidatarbete, men resulterade i en mogen backend och välutvecklad frontend som hanterar inlämning samt rättning av inlämningar.
