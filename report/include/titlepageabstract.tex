...
\begin{abstract}
    ...
    Webbapplikationen är baserad på open-source plattformen Gitorious som är implementerat i Ruby on Rails. Systemet har en avancerad webbklient vilken flitigt nyttjar MVC-strukturerade Javascript-applikationer. Processintensiva arbeten delegeras till ett system av prioritetsköer och workers. WebSocket protokollet används för asynkron kommunikation mellan webbservern och klienten. 
