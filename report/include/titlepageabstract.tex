...
\begin{abstract}
    Syftet med projektet som rapporten beskriver är att utveckla ett inlämningssystem för laborationer. Systemet byggs på verionshantering och ska hantera inlämning via en terminalklient. Inlämningar skall även gå att lämna in via ett webbgränssnitt.
